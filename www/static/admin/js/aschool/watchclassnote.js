/**
 * watch class introduce list(static/admin/js/aschool/watchclassnote.js)
 * watchtopiccomment list 
 * 
 * @copyright  Copyright (c) 2008 Community Factory Inc. (http://communityfactory.com)
 * @create    2009/12/15    xial   
 */
...
{   
    ...
    var url = UrlConfig.BaseUrl + '/ajaxaschool/listwatchclassnote';
...
function showInfo(array)
{
    ...
    for (var i = 0 ; i < array.length ; i++) {        
        ...
        var strDisabled = '';
        var strHidInput = '<input type="hidden" id="cId' + i + '" name="cId[]" value="' + array[i].cid + '" />';
        ...
        var strObjector = array[i].cid;//'<a href="javascript:void(0);" onclick="showType(2,\'' + array[i].uid + '\');return false;">' + array[i].cid + '</a>';
        ...
        html += '    <td width="50%"><a href="'+ UrlConfig.BaseUrl +'/aschool/watchclassnoteedit?cid='+ array[i].cid+'">' + strContent + '</a></td>'
