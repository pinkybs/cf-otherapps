...
class Dal_Shopping_User extends Dal_Abstract
{
    /**
     * user table name
     *
     * @var string
     */
    protected $table_user = 'shopping_user';
    ...
    {
        $sql = "SELECT COUNT(uid) FROM $this->table_user ";
    ...
    {
        $sql = "SELECT COUNT(uid) FROM $this->table_user WHERE uid<:uid";
